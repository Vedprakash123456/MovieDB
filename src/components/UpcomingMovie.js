...
export default function Upcoming() {
  ...
  var api_path = useCrud(
    `movie/upcoming?api_key=${apikey}&language=en-US&page=${id}`
  );
    ...
    for (var i = 1; i <= 10; i++) {
      msg.push(
        <li className="page-items">
          <Link class="page-link" to={"/upcoming-movie/" + i}>
            {i}
          </Link>
        </li>
      );
  ...
  return (
    <div className="container">
      <h2 className="text-center text-uppercase">Upcoming Movie Page</h2>
